module mem_top(
    ...
    wire [31:0] r_aes, r_rsa, r_ed, r_shake, r_ram, r_trng, r_spi;
    wire rd_aes, rd_rsa, rd_ed, rd_shake, rd_ram, rd_trng, rd_spi;
    ...
    trng_mm #(.BASE_ADDR(32'h4000_5000))
    u_trng (
        .clk(clk), .rst(rst),
        .addr(addr),
        .wdata(wdata),
    ...
    spi_mm #(.BASE_ADDR(32'h4000_6000))
    u_spi (
        .clk(clk), .rst(rst),
        .addr(addr),
        .wdata(wdata),
    ...
    always @(*) begin
        ...
        else if (rd_trng) begin
            rdata = r_trng;
            ready = 1'b1;
        end
        else if (rd_spi) begin
            rdata = r_spi;
            ready = 1'b1;
        end
